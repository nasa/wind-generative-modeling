...
ddpm = pd.read_csv('scripts/postprocessing/unconditional/ddpm_unconditional.csv')
fm = pd.read_csv('scripts/postprocessing/unconditional/fm_unconditional.csv')
...
sns.scatterplot(x = u_pred, y = v_pred, color = 'black', s = 5, alpha = 0.4, ax = g.ax_joint)

sns.kdeplot(x = u_pred, fill = True, ax = g.ax_marg_x, label = 'Generated')
sns.kdeplot(y = v_pred, fill = True, ax = g.ax_marg_y)
sns.kdeplot(x = u_real, fill = False, ax = g.ax_marg_x, linestyle = '--', color = 'red', label = 'Real')
sns.kdeplot(y = v_real, fill = False, ax = g.ax_marg_y, linestyle = '--', color = 'red')
