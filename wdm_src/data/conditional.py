...
from wdm_src.data import wind_velocity_unet1d_transform
...
class WindConditionDataset(Dataset):
    '''
...
if __name__ == '__main__':
    ...
    from wdm_src.diffusion import ConditionalUNet1d
    ...
    data = WindConditionDataset(wind_df, cond)
